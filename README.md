...
Requirements:
(note these requirements will be refined as we go along)
1.  Command line interface.  
2.  The command "course <xxxxx> " display all of the courses that match <xxxxx> for the data available.  It will provide pass percentage, and average grades for each instructor, grouped by instructor and year.
3.  More...
